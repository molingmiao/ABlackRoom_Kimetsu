// dump executioner.js + 顺手追加 testerPanel 新文案
const fs = require('fs');
...
const TARGETS = ['script/events/executioner.js'];
...
fs.writeFileSync('tools/translations-cache/.untranslated-batch4.json', JSON.stringify(out, null, 2), 'utf8');
