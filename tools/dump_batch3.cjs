...
const TARGETS = ['script/space.js', 'script/events.js'];
...
fs.writeFileSync('tools/translations-cache/.untranslated-batch3.json', JSON.stringify(out, null, 2), 'utf8');
